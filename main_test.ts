...
// Case #1
Deno.test(
  `[calculate capital gains] it should output no tax for buy operations`,
  async () => {
    const input = [
...
// Case #1
Deno.test(
  `[calculate capital gains] it should output no tax for sell operations of less than ${CUT_FOR_TAX_INCIDENCE}`,
  async () => {
    const input = [
      [
...
// Case #2
Deno.test(
  `[calculate capital gains] it should output ${PROFIT_TAX_PERCENTAGE}% profit tax of sell operations with profits`,
  async () => {
    const input = [
      [
...
// Case #2
Deno.test(
  `[calculate capital gains] it should output no tax for sell operations with loss`,
  async () => {
    const input = [
      [
        { operation: "buy" as OperationType, unitCost: 10, quantity: 10_000 },
...
// Case #3
Deno.test(
  `[calculate capital gains] it should deduce loss from profits and output ${PROFIT_TAX_PERCENTAGE}% tax from remainder`,
  async () => {
    const input = [
      [
        { operation: "buy" as OperationType, unitCost: 10, quantity: 10_000 },
...
// Case #4
Deno.test(
  `[calculate capital gains] it should output no tax when there's no loss or profit`,
  async () => {
    const input = [
      [
        { operation: "buy" as OperationType, unitCost: 10, quantity: 10_000 },
...
// Case #5
Deno.test(
  `[calculate capital gains] it should output ${PROFIT_TAX_PERCENTAGE}% tax from 50_000 profit`,
  async () => {
    const input = [
      [
        { operation: "buy" as OperationType, unitCost: 10, quantity: 10_000 },
...
// Case #6
Deno.test(
  `[calculate capital gains] it should deduce profits and losses and output ${PROFIT_TAX_PERCENTAGE}% from 15_000 profit`,
  async () => {
    const input = [
      [
        { operation: "buy" as OperationType, unitCost: 10, quantity: 10_000 },
...
// Case #7
Deno.test(`[calculate capital gains] case #7`, async () => {
  const input = [
    [
      { operation: "buy" as OperationType, unitCost: 10, quantity: 10_000 },
      { operation: "sell" as OperationType, unitCost: 2, quantity: 5_000 },
...
// Case #8
Deno.test(`[calculate capital gains] case #8`, async () => {
  const input = [
    [
      { operation: "buy" as OperationType, unitCost: 10, quantity: 10_000 },
